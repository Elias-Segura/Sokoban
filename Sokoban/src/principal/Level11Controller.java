 ...
 * @author Elias
 */
public class Level11Controller implements Initializable {
    ...
    private int X[] = new int[]{8,8,8,9,9,9,10,10,10,11,11,11,12,12,12};
    private int Y[] = new int[]{16,17,18,16,17,18,16,17,18,16,17,18,16,17,18};
    private static final int BoxsSave = 15;
    @FXML
    private Label Moves;
    @FXML
   ...
   private void NextLevel () throws Exception{
        i =timer.getI();
        timer.StopTimer();
        achievement = new Achievements(Name, "Level11",moves.getMoves() , moves.getPushes(),i,verifyGridPaneBox.getBoxesCount());
    ...
    private void ShowMenu(ActionEvent event) throws Exception{
        timer.StopTimer();
        achievement = new Achievements(Name, "Level11",0 , 0,0,verifyGridPaneBox.getBoxesCount());
        lista.add(achievement);
        FXMLLoader loader = new FXMLLoader();
    ...
    private void Reset(ActionEvent event)  throws Exception {
        ...
        level11ControllerInstancia.getListaAchievements(lista,Name);
        level11ControllerInstancia.setConfigVolum(ConfigVolume, ConfigSound);
        Scene tableViewScene = new Scene(tableViewParent);
        Stage window = new Stage();
        window.getIcons().add(new Image("/image/BoxLevel5.png"));
        window.setTitle("Sokoban");
