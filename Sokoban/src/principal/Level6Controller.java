...
public class Level6Controller implements Initializable {
    ...
    private void NextLevel () throws Exception{
        i =timer.getI();
        timer.StopTimer();
        achievement = new Achievements(Name, "Level6",moves.getMoves() , moves.getPushes(),i, verifyGridPaneBox.getBoxesCount());
        ...
        level7ControllerInstancia.getListaAchievements(lista, Name);
        level7ControllerInstancia.setConfigVolum(ConfigVolume, ConfigSound);
    ...
    private void ShowMenu(ActionEvent event) throws Exception{
        timer.StopTimer();
        achievement = new Achievements(Name, "Level6",0,0,0, verifyGridPaneBox.getBoxesCount());
        lista.add(achievement);
        FXMLLoader loader = new FXMLLoader();
