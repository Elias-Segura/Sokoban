...
public class Level4Controller implements Initializable {
    ...
    private int X[] = new int[]{8,8,8,8,9,9,9,9,10,10,10,10};
    private int Y[] = new int[]{5,6,7,8,5,6,7,8,5,6,7,8};
    private static final int BoxsSave = 12;
    @FXML
    private Label Moves;
    @FXML
    ...
    private void NextLevel () throws Exception{
       i =timer.getI();
       timer.StopTimer();
       achievement = new Achievements(Name, "Level4",moves.getMoves() , moves.getPushes(),i,verifyGridPaneBox.getBoxesCount());
    ...
    private void ShowMenu(ActionEvent event) throws Exception{
        timer.StopTimer();
        achievement = new Achievements(Name, "Level4",0,0,0,verifyGridPaneBox.getBoxesCount());
        lista.add(achievement);
        FXMLLoader loader = new FXMLLoader();
    ...
    private void Reset(ActionEvent event)  throws Exception {
        ...
        level4ControllerInstancia.getListaAchievements(lista, Name);
        level4ControllerInstancia.setConfigVolum(ConfigVolume, ConfigSound);
        Scene tableViewScene = new Scene(tableViewParent);
        Stage window = new Stage();
        window.getIcons().add(new Image("/image/BoxLevel5.png"));
        window.setTitle("Sokoban");
