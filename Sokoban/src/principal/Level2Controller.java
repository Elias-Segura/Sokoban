...
public class Level2Controller implements Initializable {
    ...
    private String Name;
     private Achievements achievement = new Achievements();
    ...
    private int Y[] = new int[]{2,2,2,2,2,3,3,3,3,3};
   ...
   private void NextLevel () throws Exception{
        i =timer.getI();
        timer.StopTimer();
        achievement = new Achievements(Name, "Level2",moves.getMoves() , moves.getPushes(),i,verifyGridPaneBox.getBoxesCount());
    ...
    private void ShowMenu(ActionEvent event) throws Exception{
        timer.StopTimer();
        achievement = new Achievements(Name, "Level2",0,0,0,verifyGridPaneBox.getBoxesCount());
        lista.add(achievement);
        FXMLLoader loader = new FXMLLoader();
