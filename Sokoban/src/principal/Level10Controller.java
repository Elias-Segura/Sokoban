 ...
 * @author Elias
 */
public class Level10Controller implements Initializable {
    ...
    private int X[] = new int[]{13,13,13,13,13,12,12,12,12,11,11,11,11,10};
    private int Y[] = new int[]{2,3,4,5,6,2,3,4,6,2,3,5,6,2};
   ...
   private void NextLevel () throws Exception{
        i =timer.getI();
        timer.StopTimer();
        achievement = new Achievements(Name, "Level10",moves.getMoves() , moves.getPushes(),i,verifyGridPaneBox.getBoxesCount());
    ...
    private void ShowMenu(ActionEvent event) throws Exception{
        timer.StopTimer();
        achievement = new Achievements(Name, "Level10",0,0,0,verifyGridPaneBox.getBoxesCount());
        lista.add(achievement);
        FXMLLoader loader = new FXMLLoader();
