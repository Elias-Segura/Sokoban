...
public class Level7Controller implements Initializable {
    ...
    private int X[] = new int[]{10,10,10, 11,11,11,11,12,12,12,12 };
    private int Y[] = new int[]{16,17,18, 15,16,17,18, 15,16,17,18 };
    private static final int BoxsSave = 11;
    @FXML
    private Label Moves;
    @FXML
   ...
   private void NextLevel () throws Exception{
        i =timer.getI();
        timer.StopTimer();
        achievement = new Achievements(Name, "Level7",moves.getMoves() , moves.getPushes(),i,verifyGridPaneBox.getBoxesCount());
    ...
    private void ShowMenu(ActionEvent event) throws Exception{
        timer.StopTimer();
        achievement = new Achievements(Name, "Level7",0,0,0,verifyGridPaneBox.getBoxesCount());
        lista.add(achievement);
        FXMLLoader loader = new FXMLLoader();
